# 适用于与Amazon S3兼容云存储的Minio Go SDK [![Slack](https://slack.minio.io/slack?type=svg)](https://slack.minio.io) [![Sourcegraph](https://sourcegraph.com/github.com/jazzsir/minio-go/-/badge.svg)](https://sourcegraph.com/github.com/jazzsir/minio-go?badge)
...
* [listenbucketnotification.go](https://github.com/jazzsir/minio-go/blob/master/examples/minio/listenbucketnotification.go) (Minio扩展)
...
## 贡献
[贡献指南](https://github.com/jazzsir/minio-go/blob/master/docs/zh_CN/CONTRIBUTING.md)
